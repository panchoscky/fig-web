...
| `fiw/index.html` | ⚠️ Placeholder, **enlaces reactivados** | Estructura y datos completos (3 co-fundadoras: Delia Avilán, Gabriela Domínguez y Victoria Espinoza), pero **colores de marca aún no confirmados** por el equipo FIW — usa un oro rosa provisional. Sin fotos en `fotos/fiw/` todavía. **2026-07-27, pedido de Francisco**: se reactivaron los 8 enlaces que se habían ocultado el 2026-07-24 para el lanzamiento (nav desktop y móvil de `index.html`, la tarjeta del desk 04 en §Áreas, el footer de `index.html`, y los nav de `404.html`, `postula/index.html` y `eventos/index.html`) — se quitó el comentario `FIW_TEMP_OCULTO` en los 4 archivos, nada se reescribió a mano. Verificado con Playwright: los 8 enlaces navegan a `fiw/index.html`, 0 errores de consola. Pendiente: colores de marca (P0-3) y fotos reales |
