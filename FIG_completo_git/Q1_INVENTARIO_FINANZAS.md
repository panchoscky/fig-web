...
- 🔄 **Q2 en curso:** 16 lotes hechos (2026-07-17) — `finanzas-01.json` a `finanzas-16.json`, **224 preguntas totales** cubriendo matemática financiera, análisis de ratios, renta fija (incl. instrumentos chilenos LCH/MHE/PRC/BCU y duración/inmunización), riesgo financiero, evaluación de proyectos (incl. opciones reales con árbol de decisión, CAE con alternativas), CAPM/portafolios/CML, estructura de capital (M&M/WACC, teorema de Fisher, irrelevancia del financiamiento), historia de mercados, macroeconomía y fundamentos/gobierno corporativo, desde 42 archivos distintos entre "Intro a Finanzas" y "Finanzas I" (el encabezado real del documento no siempre coincide con la carpeta del Drive). 4 archivos descartados por baja confiabilidad. Antes de extraer se hace siempre un escaneo rápido de calidad (sin comprometerse a extraer) — con los últimos 35 archivos escaneados (2 rondas de 15+20) solo 5 resultaron inservibles, muy buen ratio. Quedan archivos sin escanear en Intro a Finanzas y Finanzas I + Finanzas II (45) + APF (7)
