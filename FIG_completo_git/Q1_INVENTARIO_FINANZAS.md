...
- 🔄 **Q2 en curso:** 20 lotes hechos (2026-07-17) — `finanzas-01.json` a `finanzas-20.json`, **266 preguntas totales** cubriendo 12 temas: matemática financiera, análisis de ratios, renta fija, riesgo financiero (incl. VaR), evaluación de proyectos, CAPM/portafolios/CML avanzado, estructura de capital, historia de mercados, macroeconomía, fundamentos/gobierno corporativo, y los 2 temas nuevos **derivados-futuros** y **derivados-opciones** (forwards, futuros, cobertura, opciones, Black-Scholes, árboles binomiales, delta hedging), confirmados con Francisco para su uso en el Desafío. Desde 57 archivos distintos entre "Intro a Finanzas" y "Finanzas I". 4 archivos descartados por baja confiabilidad. Antes de extraer se hace siempre un escaneo rápido de calidad. Quedan 10 archivos de derivados sin escanear en "Finanzas I", más el resto de "Intro a Finanzas" + "Finanzas II" (45, previsiblemente más derivados avanzados) + APF (7)
