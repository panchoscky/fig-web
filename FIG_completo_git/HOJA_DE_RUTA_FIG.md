...
| 2026-07-18 | Primeras fotos reales de la directiva | Francisco subió 7 fotos (extraídas de LinkedIn) a una carpeta "Fotos" dentro de la carpeta CV del Drive. Se bajaron las 6 que corresponden a personas de `personas.directiva` y se guardaron en `fotos/directiva/` con el slug exacto que espera `probeFoto()`: `benjamin-saez-molina.jpg`, `jhosep-garcia.jpg` (convertida de PNG a JPG, 590 KB → 73 KB), `francisco-valenzuela.jpg`, `benjamin-disi.jpg` (convertida de PNG a JPG, 511 KB → 61 KB), `rafael-aliendre.jpg`, `david-gonzalez-canon.jpg`. La séptima foto ("samuel linkedin.jfif") no se usó: Samuel Rodríguez Arnolds solo está en `personas.industria`, grupo que no tiene columna de foto en el Expediente — no hay dónde mostrarla hoy. Verificado con Playwright: el Expediente ya carga las fotos reales de Sáez y García (antes monograma) sin tocar código ni JSON, exactamente como describe `fotos/directiva/LEEME.txt` |
