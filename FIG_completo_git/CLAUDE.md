...
| Fotos de la directiva | ⚠️ Parcial (9/13) | `fotos/directiva/` ya tiene foto real de Benjamín Sáez Molina, Jhosep García, Francisco Valenzuela (mejorada 2026-07-19: reescalada 200px→900px con Lanczos + realce de nitidez), Benjamín Disi, Rafael Aliendre, David González Cañon, Samuel Rodríguez Arnolds, Juan Pablo Díaz Cerda y Benjamín Solís. Faltan Manuel Paz, Agustín Arriagada, Juan José Limari y Delia Avilán — siguen mostrando el monograma dorado hasta que suban la suya (ver `fotos/directiva/LEEME.txt`). Nota: Samuel Rodríguez Arnolds se sumó a `personas.directiva` el 2026-07-18 (co-encargado de Valuation junto a Jhosep, confirmado por Francisco) — antes solo estaba en `personas.industria` |
