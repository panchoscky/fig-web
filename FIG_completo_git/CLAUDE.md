...
| Fotos de la directiva | ⚠️ Parcial (7/13) | `fotos/directiva/` ya tiene foto real de Benjamín Sáez Molina, Jhosep García, Francisco Valenzuela, Benjamín Disi, Rafael Aliendre, David González Cañon y Samuel Rodríguez Arnolds (2026-07-18, subidas por Francisco vía LinkedIn al Drive). Faltan Manuel Paz, Agustín Arriagada, Benjamín Solís, Juan José Limari, Juan Pablo Díaz Cerda y Delia Avilán — siguen mostrando el monograma dorado hasta que suban la suya (ver `fotos/directiva/LEEME.txt`). Nota: Samuel Rodríguez Arnolds se sumó a `personas.directiva` recién el 2026-07-18 (co-encargado de Valuation junto a Jhosep, confirmado por Francisco) — antes solo estaba en `personas.industria` |
